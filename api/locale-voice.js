const LOCALES = {
  ...
  ko: {
    ...
    length: "각 본문은 공백 포함 350~550자 안팎으로 충분히 상세하게 쓰세요.",
    rules: [
      ...
      "technicalBasis도 한국어로 쓰고, 八字·戊子·Bing-Yin 같은 원문 표기 대신 '만세력의 네 기둥', '병인일주의 흐름'처럼 뜻을 풀어 쓰세요. 오행 수치는 '수 5.05'처럼 한국어 이름으로 씁니다.",
      "각 본문은 최소 5문장으로 쓰고 350자보다 짧게 요약하지 마세요. 제목에서는 '당신'보다 이름이나 구체적인 사주 흐름을 쓰세요.",
      "본문 대부분은 명리 용어가 아니라 일상에서 겪을 법한 장면이나 마음의 모순으로 시작하세요. 근거는 한두 문장만 정확히 붙이고, 숫자 나열은 오행 균형 항목에만 두세요.",
      ...
      "조언은 명령문만 이어 쓰지 말고 선택권을 남겨주세요. '해보세요'뿐 아니라 '그래도 괜찮아요', '먼저 줄여도 돼요', '이 정도면 충분해요'처럼 자연스러운 허용의 문장을 섞으세요.",
      ...
      "'먼저 마음을 헤아려볼게요', '이 풀이에서는', '뒤에서 설명할게요'처럼 글의 진행을 중계하지 마세요. 바로 관찰과 근거를 자연스럽게 이어가세요."
    ]
  },
  "zh-CN": {
    name: "自然、克制的简体中文",
